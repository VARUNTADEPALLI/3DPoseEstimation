...
def get_joint_setting(mesh_model, joint_category='human36'):
    ...
    if joint_category == 'human36':
        ...
        model_chk_path = '/content/drive/MyDrive/GTRS-mains/experiment/gtrs_h36m'
        ...
        graph_Adj, graph_L, graph_perm, graph_perm_reverse = \
            build_coarse_graphs(mesh_model.face, joint_num, skeleton, flip_pairs, levels=9)
        model_chk_path = '/content/drive/MyDrive/GTRS-mains/experiment/gtrs_3dpw'
...
if __name__ == '__main__':
    ...
    output_path = '/content/drive/MyDrive/GTRS-mains/demo/result/'
    ...
    if input_path != '.':  # user specific input
        ...
        #joint_input = joint_input[:-1].reshape(17, -1)
        #joint_input = joint_input.reshape(18,-1)
      ...
      # file_path = output_path + '/gtrs_demo_mesh.png'
      # print("Saving to:", file_path)
      # result = cv2.imwrite(file_path, rendered_img)
      # if result:
      #     print("Image saved.")
      # else:
